...
*****************************************/
 // 找到 run_xxxx 的位置
  ...
  h_spectrum = new TH2I("mat_all_spectrum","g-g matrix all event",4096,0,MATRIX_ENERGY_MAX,4096,0,MATRIX_ENERGY_MAX);//keV
  h79 = new TH2I("mat_79","g-g 79 deg matrix all event",4096,0,MATRIX_ENERGY_MAX,4096,0,MATRIX_ENERGY_MAX);//keV
  h37 = new TH2I("mat_37","g-g 37 deg matrix all event",4096,0,MATRIX_ENERGY_MAX,4096,0,MATRIX_ENERGY_MAX);//keV
  h101 = new TH2I("mat_101","g-g 101 matrix all event",4096,0,MATRIX_ENERGY_MAX,4096,0,MATRIX_ENERGY_MAX);//keV
  h143 = new TH2I("mat_143","g-g 143 deg matrix all event",4096,0,MATRIX_ENERGY_MAX,4096,0,MATRIX_ENERGY_MAX);//keV
  h79_random = new TH2I("mat_79_random","g-g 79 deg matrix all event",4096,0,MATRIX_ENERGY_MAX,4096,0,MATRIX_ENERGY_MAX);//keV
  h37_random = new TH2I("mat_37_random","g-g 37 deg matrix all event",4096,0,MATRIX_ENERGY_MAX,4096,0,MATRIX_ENERGY_MAX);//keV
  h101_random = new TH2I("mat_101_random","g-g 101 matrix all event",4096,0,MATRIX_ENERGY_MAX,4096,0,MATRIX_ENERGY_MAX);//keV
  h143_random = new TH2I("mat_143_random","g-g 143 deg matrix all event",4096,0,MATRIX_ENERGY_MAX,4096,0,MATRIX_ENERGY_MAX);//keV
  h79_spectrum = new TH2I("mat_79_spectrum","g-g 79 deg matrix all event",4096,0,MATRIX_ENERGY_MAX,4096,0,MATRIX_ENERGY_MAX);//keV
  h37_spectrum = new TH2I("mat_37_spectrum","g-g 37 deg matrix all event",4096,0,MATRIX_ENERGY_MAX,4096,0,MATRIX_ENERGY_MAX);//keV
  h101_spectrum = new TH2I("mat_101_spectrum","g-g 101 matrix all event",4096,0,MATRIX_ENERGY_MAX,4096,0,MATRIX_ENERGY_MAX);//keV 
  h143_spectrum = new TH2I("mat_143_spectrum","g-g 143 deg matrix all event",4096,0,MATRIX_ENERGY_MAX,4096,0,MATRIX_ENERGY_MAX);//keV
...
//
  ...
  TString filename2 = gSystem->BaseName(filename);
  ...
  file_out = new TFile(TString::Format("../../rootfile/%s_mat_clean_lifetime.root",filename2.Data()),"RECREATE");
...
void sort::clearopt()
{
  ...
  memset(DetFlag,0,sizeof(DetFlag));
  nhitoneevent = 0;
...
void sort::Processxc()
{
  ...
  h101_random->Write();
  h143_random->Write();
  h_spectrum->Add(h_prompt,h_random,1,-1);
  h37_spectrum->Add(h37,h37_random,1,-1);
  h79_spectrum->Add(h79,h79_random,1,-1);
  h101_spectrum->Add(h101,h101_random,1,-1);
  h143_spectrum->Add(h143,h143_random,1,-1);
  h_spectrum->Write();
  h37_spectrum->Write();
  h79_spectrum->Write();
  h101_spectrum->Write();
  ...
  if(tmp >= THRE_LOW && tmp <= THRE_HIGH)
    {
      ...
      DetFlag[detflag[flagchtmp]] = flagchtmp;
...
// add EH anti compton
    ...
    for(int i=0;i<33;i++){
      ...
      for(int j=0;j<33;j++){
        if(i==j) continue;
        if(DetEnergy[j][0]>0){
          // theh->Fill(DetEnergy[i][0],DetEnergy[j][0]); // std::cout << "==============>1" << std::endl; 
          
          // prompt
          if(b){
            h_prompt->Fill(DetEnergy[i][0],DetEnergy[j][0]); //std::cout << "==============>1" << std::endl;      
            if((DetFlag[i]==0 || DetFlag[i]==2 || DetFlag[i]==6 || DetFlag[i]==8 || DetFlag[i]==10 || DetFlag[i]==12 || DetFlag[i]==14 || DetFlag[i]==16 || DetFlag[i]==18 || DetFlag[i]==20 || DetFlag[i]==22 || DetFlag[i]==24 || DetFlag[i]==26 || DetFlag[i]==28 || DetFlag[i]==30 || DetFlag[i]==32) && (DetFlag[j]==8  || DetFlag[j]==16 || DetFlag[j]==18 || DetFlag[j]==20 || DetFlag[j]==22))      {
              h79->Fill(DetEnergy[i][0],DetEnergy[j][0]);//std::cout << "================>2" << std::endl; 
              prompt_vector.push_back(h79);
              }
            if((DetFlag[i]==0 || DetFlag[i]==2 || DetFlag[i]==6 || DetFlag[i]==8 || DetFlag[i]==10 || DetFlag[i]==12 || DetFlag[i]==14 || DetFlag[i]==16 || DetFlag[i]==18 || DetFlag[i]==20 || DetFlag[i]==22 || DetFlag[i]==24 || DetFlag[i]==26 || DetFlag[i]==28 || DetFlag[i]==30 || DetFlag[i]==32) && (DetFlag[j]==10 || DetFlag[j]==12 || DetFlag[j]==14 ))                       {
              h37->Fill(DetEnergy[i][0],DetEnergy[j][0]);//std::cout << "==================>3" << std::endl; 
              prompt_vector.push_back(h37);
              }
            if((DetFlag[i]==0 || DetFlag[i]==2 || DetFlag[i]==6 || DetFlag[i]==8 || DetFlag[i]==10 || DetFlag[i]==12 || DetFlag[i]==14 || DetFlag[i]==16 || DetFlag[i]==18 || DetFlag[i]==20 || DetFlag[i]==22 || DetFlag[i]==24 || DetFlag[i]==26 || DetFlag[i]==28 || DetFlag[i]==30 || DetFlag[i]==32) && (DetFlag[j]==0  || DetFlag[j]==6  || DetFlag[j]==24 || DetFlag[j]==32))                       {
              h101->Fill(DetEnergy[i][0],DetEnergy[j][0]);//std::cout << "====================>4" << std::endl;
              prompt_vector.push_back(h101);
              }
            if((DetFlag[i]==0 || DetFlag[i]==2 || DetFlag[i]==6 || DetFlag[i]==8 || DetFlag[i]==10 || DetFlag[i]==12 || DetFlag[i]==14 || DetFlag[i]==16 || DetFlag[i]==18 || DetFlag[i]==20 || DetFlag[i]==22 || DetFlag[i]==24 || DetFlag[i]==26 || DetFlag[i]==28 || DetFlag[i]==30 || DetFlag[i]==32) && (DetFlag[j]==2  || DetFlag[j]==26 || DetFlag[j]==28 || DetFlag[j]==30))                       {
              h143->Fill(DetEnergy[i][0],DetEnergy[j][0]);//std::cout << "======================>5" << std::endl; 
              prompt_vector.push_back(h143);
              }
            // std::cout << "DetFlag j: " << DetFlag[j] << std::endl;
          }
          // random
          if(!b){
            h_random->Fill(DetEnergy[i][0],DetEnergy[j][0]); //std::cout << "==============>1" << std::endl;      
            if((DetFlag[i]==0 || DetFlag[i]==2 || DetFlag[i]==6 || DetFlag[i]==8 || DetFlag[i]==10 || DetFlag[i]==12 || DetFlag[i]==14 || DetFlag[i]==16 || DetFlag[i]==18 || DetFlag[i]==20 || DetFlag[i]==22 || DetFlag[i]==24 || DetFlag[i]==26 || DetFlag[i]==28 || DetFlag[i]==30 || DetFlag[i]==32) && (DetFlag[j]==8  || DetFlag[j]==16 || DetFlag[j]==18 || DetFlag[j]==20 || DetFlag[j]==22))      {
              h79_random->Fill(DetEnergy[i][0],DetEnergy[j][0]);//std::cout << "================>2" << std::endl; 
              random_vector.push_back(h79_random);
              }
            if((DetFlag[i]==0 || DetFlag[i]==2 || DetFlag[i]==6 || DetFlag[i]==8 || DetFlag[i]==10 || DetFlag[i]==12 || DetFlag[i]==14 || DetFlag[i]==16 || DetFlag[i]==18 || DetFlag[i]==20 || DetFlag[i]==22 || DetFlag[i]==24 || DetFlag[i]==26 || DetFlag[i]==28 || DetFlag[i]==30 || DetFlag[i]==32) && (DetFlag[j]==10 || DetFlag[j]==12 || DetFlag[j]==14 ))                       {
              h37_random->Fill(DetEnergy[i][0],DetEnergy[j][0]);//std::cout << "==================>3" << std::endl; 
              random_vector.push_back(h37_random);
              }
            if((DetFlag[i]==0 || DetFlag[i]==2 || DetFlag[i]==6 || DetFlag[i]==8 || DetFlag[i]==10 || DetFlag[i]==12 || DetFlag[i]==14 || DetFlag[i]==16 || DetFlag[i]==18 || DetFlag[i]==20 || DetFlag[i]==22 || DetFlag[i]==24 || DetFlag[i]==26 || DetFlag[i]==28 || DetFlag[i]==30 || DetFlag[i]==32) && (DetFlag[j]==0  || DetFlag[j]==6  || DetFlag[j]==24 || DetFlag[j]==32))                       {
              h101_random->Fill(DetEnergy[i][0],DetEnergy[j][0]);//std::cout << "====================>4" << std::endl;
              random_vector.push_back(h101_random);
              }
            if((DetFlag[i]==0 || DetFlag[i]==2 || DetFlag[i]==6 || DetFlag[i]==8 || DetFlag[i]==10 || DetFlag[i]==12 || DetFlag[i]==14 || DetFlag[i]==16 || DetFlag[i]==18 || DetFlag[i]==20 || DetFlag[i]==22 || DetFlag[i]==24 || DetFlag[i]==26 || DetFlag[i]==28 || DetFlag[i]==30 || DetFlag[i]==32) && (DetFlag[j]==2  || DetFlag[j]==26 || DetFlag[j]==28 || DetFlag[j]==30))                       {
              h143_random->Fill(DetEnergy[i][0],DetEnergy[j][0]);//std::cout << "======================>5" << std::endl; 
              random_vector.push_back(h143_random);
              }
            }
      }
      // if(b){
      //   prompt_vector.push_back(h_prompt);
      //   prompt_vector.push_back(h79);
      //   prompt_vector.push_back(h37);
      //   prompt_vector.push_back(h101);
      //   prompt_vector.push_back(h143);
      ...
      // }
      // else{
      //   random_vector.push_back(h_random);
      //   random_vector.push_back(h79_random);
      //   random_vector.push_back(h37_random);
      //   random_vector.push_back(h101_random);
      //   random_vector.push_back(h143_random);
