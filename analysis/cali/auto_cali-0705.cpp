...
// In beam
const int num_Inbeam = 7;
double e_Inbeam[num_Inbeam] = {53.1, 96.1, 213.6, 360.86, 609.22, 834.01, 1039.51};
// double e_Inbeam[num_Inbeam] = {53.1, 96.1, 200.0, 213.6, 360.9, 511.0, 834.0, 1039.6, 1143.89};
