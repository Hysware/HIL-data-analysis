...
// Mon Aug 25 09:16:43 2025 by ROOT version 6.34.02
// from TTree three/three_fold_energy
// found on file: three.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("three.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("three.root");
      }
      f->GetObject("three",tree);
...
void dataTree::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("energy3", &energy3, &b_energy3);
   Notify();
}
